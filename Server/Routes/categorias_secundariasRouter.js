...
Router.post('/insert', requireAuth, async (req, res) => {
  try {
    const body = req.body;
    console.log('categorias_secundarias_insert body:', body); // Debug log
...
Router.post('/update', requireAuth, async (req, res) => {
  try {
    const body = req.body;
    console.log('categorias_secundarias_update body:', body); // Debug log
...
Router.post('/delete', requireAdmin, async (req, res) => {
  try {
    const body = req.body;
    console.log('categorias_secundarias_delete body:', body); // Debug log
...
Router.get('/por_id/:categoria_secundaria_id', async (req, res) => {
  try {
    ...
    console.log('categorias_secundarias_get_by_id body:', body); // Debug log
