...
Router.post('/insert', requireAuth, async (req, res) => {
  try {
    const body = req.body;
    console.log('subcategorias_insert body:', body); // Debug log
...
Router.post('/update', requireAuth, async (req, res) => {
  try {
    const body = req.body;
    console.log('subcategorias_update body:', body); // Debug log
...
Router.post('/delete', requireAdmin, async (req, res) => {
  try {
    const body = req.body;
    console.log('subcategorias_delete body:', body); // Debug log
...
Router.get('/por_id/:subcategoria_id', async (req, res) => {
  try {
    ...
    console.log('subcategorias_get_by_id body:', body); // Debug log
